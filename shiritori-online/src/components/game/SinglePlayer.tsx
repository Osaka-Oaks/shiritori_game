...
import { romajiToHiragana, speak } from "../../lib/japanese/romaji";
import { lookupWord } from "../../lib/dictionary/lookup";
import { needsReadingLookup } from "../../lib/japanese/japanese";
import { LEVEL_LIST, type LevelId, parseLevelId } from "../../lib/game/levels";
import {
  createSoloGame,
  cpuMove,
  applyPlayerWord,
  attachWordMeta,
  type SoloState,
} from "../../lib/game/solo-engine";
import { loadDevSettings, saveDevSettings, type DevSettings } from "../../lib/dev/dev-mode";
    ...
    const id = window.setInterval(() => {
      setSecondsLeft(s => {
        if (s <= 1) {
          ...
          setGame(g =>
            g
              ? { ...g, status: "lost", endReason: "⏰ Time's up!", lastFeedback: "⏰ Time's up!" }
              : g
          );
          return 0;
        }
    ...
    return (
      <div className="app fade-in">
        ...
        <div className="card">
          ...
          {dev.enabled && <p className="sp-dev-badge">🛠 Dev mode on — open solo with ?dev=1</p>}
