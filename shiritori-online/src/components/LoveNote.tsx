...
export default function LoveNote({ fromName, onClose }: Props) {
  ...
  return (
    <div className="love-overlay fade-in" onClick={onClose} role="dialog" aria-label="A note for Mei">
      ...
      <div className="love-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="love-body">
          <p>
            Mei, I made this little game just for us. 💛 I love you — and more than
            anything I want a small moment that&apos;s only ours, every day. So let&apos;s
            play for five minutes every night, win or lose, and just be together.
          </p>
          <p className="love-jp-block" lang="ja">
            メイへ。このゲームは、ふたりのためにつくったよ。💛
            あいしてる。まいばん5ふんだけでも、きみといっしょのじかんがほしいんだ。
            かっても まけても、ふたりでいられたら それでしあわせ。
          </p>
