...
import OthelloPlaceholder from "./components/OthelloPlaceholder";
...
export default function App() {
  ...
  const handleQuickTest = () => {
    // Immediately start game with default easy bot (Usagi Chan) - no avatar picker needed
    setSelectedBot(BOT_OPPONENTS[0]); // Usagi Chan - easy bot
    setActiveView("GAME_ROOM");
  };
