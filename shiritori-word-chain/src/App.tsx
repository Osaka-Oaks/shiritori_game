    ...
    <div className="min-h-screen bg-[#050505] text-[#D1D1D1] flex flex-col font-sans selection:bg-[#C5A059]/30 selection:text-white">
      ...
      <header className="bg-[#0A0A0A] border-b border-white/10 sticky top-0 z-40 shrink-0">
        <div className="max-w-4xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
          <div
            className="flex items-center gap-3 cursor-pointer w-full md:w-auto justify-between md:justify-start"
            onClick={() => {
              setIsPlaying(false);
              setActiveTab("game");
            }}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="serif-italic text-xl tracking-wide text-white flex items-center gap-2">
                  Shiritori{" "}
                  <span className="text-[10px] font-bold border border-[#C5A059]/30 text-[#C5A059] px-1.5 py-0.5 rounded-sm lowercase font-sans">
                    しりとり
                  </span>
                </h1>
                <span className="font-sans text-[8px] text-white/40 font-semibold block tracking-[0.25em] leading-none mt-0.5 uppercase">
                  WORD CHAIN ARENA
                </span>
              </div>
            </div>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-center">
                        <span
                          className={`px-2 py-0.5 rounded-sm font-sans tracking-widest text-[9px] inline-block leading-none ${op.badgeStyle}`}
                        >
                          {op.badge}
                        </span>
              ...
              <section className="glass-card rounded-sm p-6 w-full">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                  <div className="space-y-1.5 text-center md:text-left">
                    ...
                    <p className="font-light text-xs text-white/50 leading-relaxed">
                      Easy mode is perfect for beginners and features dynamic typo hints.
                    </p>
                  </div>
